...
export function Banner() {
    ...
    return (
        <section className="w-full sm:w-[90%] md:w-[85%] lg:w-[80%] xl:w-[75%] 2xl:w-[65%] sm:mx-auto my-12">
            <div className="flex flex-col items-center text-center gap-y-10 lg:flex-row lg:text-start sm:gap-10 lg:gap-14">
                <div className="w-full lg:w-1/2 flex flex-col items-center lg:items-start gap-y-10 sm:gap-y-8">
                    <h1
                    ...
                    ></h1>
                    <p className={`text-lg text-gray-300 ${locale === "ka" ? "font-Helvetica" : "font-avenirHeavy"} w-[90%] mx-auto lg:mx-0`}>
                        {t("description")}
                    </p>
